                            ...
                            <table class="table table-striped" id="tableEstimate">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text" name="buying_price" class="form-control adjust buying_price" value="{{$spi_po->buying_price}}"></td>
                                        <td><input type="text" name="expenses" class="form-control adjust expenses" value="{{$spi_po->expenses}}"></td>
                                        <td><input type="text" name="price_expenses" class="form-control adjust price_expense" value="{{$spi_po->price_expenses}}" readonly></td>
